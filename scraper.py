...
stations_url = "{root_url}?srsname=EPSG:27700&outputFormat=GEOJSON&request=GetFeature&service=wfs&typename=Polling_Stations".format(root_url=root_url)
districts_url = "{root_url}?srsname=EPSG:27700&outputFormat=GEOJSON&request=GetFeature&service=wfs&typename=Polling_Districts".format(root_url=root_url)
council_id = 'DND'
